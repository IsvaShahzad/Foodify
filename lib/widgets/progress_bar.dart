                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: index <= currentIndex ? Colors.blueGrey : Colors.white,
                          border: Border.all(
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: TextStyle(
                              color: index <= currentIndex ? Colors.white : Colors.blueGrey,
...
class ProgressLinePainter extends CustomPainter {
  ...
  ProgressLinePainter({required this.stepCount, required this.stepWidth});
